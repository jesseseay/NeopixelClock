...
uint32_t brown = strip.Color(10, 4, 0); // 1
uint32_t red = strip.Color(136, 0, 0); // 2
uint32_t orange = strip.Color(136, 29, 0); // 3
uint32_t yellow = strip.Color(108, 101, 0); // 4
uint32_t green = strip.Color(0, 67, 0);// 5
uint32_t blue = strip.Color(0, 0, 67); // 6
uint32_t violet = strip.Color(62, 0, 163); // 7
uint32_t grey = strip.Color(36, 49, 48); //cyan  8-- change to gray later
